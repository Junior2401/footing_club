                            ...
                            <div class="col-lg-9">
                                <div class="card shadow-lg border-0 rounded-lg">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form  method="POST" action="./AddContactController.php">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" placeholder="07 00 00 00 00" name="telephone" required />
