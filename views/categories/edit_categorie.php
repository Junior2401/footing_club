                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div class="card shadow-lg border-0 rounded-lg">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modifier categorie</h3></div>
                                    <div class="card-body">
                                        <?php 
                                        ...
                                        ?>
                                        <?php if ($categorie): ?>
                                        <form  method="POST" action="./EditCategorieController.php?id=<?php echo $categorie->getId(); ?>">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text"  name="code"  value="<?php echo $categorie->getCode(); ?>" required />
                                                        <label for="inputFirstName">Code</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="nom"  value="<?php echo $categorie->getNom(); ?>" required />
