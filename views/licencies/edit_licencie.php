                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-9">
                                        <div class="card shadow-lg border-0 rounded-lg">
                                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Modifier licencié</h3></div>
                                            <div class="card-body">
                                            <div class="message">
                                                <?php 
                                        ...
                                        <?php if ($licencie): ?>
                                        <form  method="POST" action="./EditLicencieController.php?id=<?php echo $licencie->getId(); ?>">
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
