                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row p-3">
                            <div class="col-xl-3 col-md-6">
                                <a class="btn btn-primary" href="#">Nouveau <i class="fa-solid fa-circle-plus"></i></a>
                            </div>
                        </div>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <?php foreach ($contacts as $contact): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  class="btn btn-success btn-sm" href="ViewContactController.php?id=<?php echo $contact->getId(); ?>"><i class="fa-solid fa-circle-info text-white"></i></a>
                                                    ...
                                                    <a  class="btn btn-danger btn-sm" href="DeleteContactController.php?id=<?php echo $contact->getId(); ?>"><i class="fa-solid fa-trash-can textwhtext-white"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
